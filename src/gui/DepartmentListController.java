...
public class DepartmentListController implements Initializable, DataChangeListener {
	...
	// armazena a lista de departmentos
	private DepartmentService service;

	// carrega os departamento
	...
	public void onBtnewAction(ActionEvent event) {
		...
		createDialogForm(obj, "/gui/DepartmentForm.fxml", parentetStage);
	}

	// pego a lista de departamentos do model service
